  ...
  return (
    <div className="admin-rooms">
      <div className="admin-header">
        <h1>Quản Lý Phòng</h1>
        <Link to="/admin/rooms/add" className="add-button">Thêm Phòng Mới</Link>
      </div>
            ...
            <tbody>
              {filteredRooms.map(room => (
                <tr key={room.id}>
                  ...
                  <td>{room.size} m²</td>
                  <td>
                    <span className={`status-badge ${room.is_occupied ? 'occupied' : 'available'}`}>
                  ...
                  <td className="action-buttons">
                    ...
                    <Link to={`/admin/rooms/view/${room.id}`} className="view-button">
                      <FaEye /> Xem
                    </Link>
                    <button 
